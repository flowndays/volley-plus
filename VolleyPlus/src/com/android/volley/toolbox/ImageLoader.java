...
public class ImageLoader {
    ...
    /**
     * HashMap of in-flight tasks of reading from the disCache.
     */
    private final HashMap<String, LoadFromDiskTask> mInFlightLoaders = new HashMap<String, LoadFromDiskTask>();
    ...
    /**
     * Cache adapter interface. Implementation with an LruCache is recommended.
     */
    ...
    private void onGetImageSuccess(String cacheKey, Bitmap response) {
        ...
        mCache.addBitmapToCache(cacheKey, response, Bitmap.CompressFormat.PNG);
    ...
    private class LoadFromDiskTask extends AsyncTask<String, Void, Bitmap> {
        private String cacheKey;
        private String requestUrl;
        private int maxWidth;
        private int maxHeight;
        private final HashSet<ImageContainer> mContainers = new HashSet<ImageContainer>();

        private LoadFromDiskTask(String cacheKey, String requestUrl, int maxWidth, int maxHeight, ImageContainer container) {
        ...
        protected Bitmap doInBackground(String... params) {
            return mCache.getBitmapFromDiskCache(cacheKey, maxWidth, maxHeight);
        }
        ...
        private void onLoadImageFinish(String cacheKey, Bitmap response) {
            // cache the image that was fetched.
            if (response != null) {
                mCache.addBitmapToMemCache(cacheKey, response);
            }
            mInFlightLoaders.remove(cacheKey);
        }
    }
